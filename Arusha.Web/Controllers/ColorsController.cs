...
namespace Arusha.Web.Controllers
{
    public class ColorsController : Controller
    {
        ...
        public ColorsController(ArushaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Key,Name,AlterName,Id")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Key,Name,AlterName,Id")] Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
